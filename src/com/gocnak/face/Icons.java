    ...
    public static BotnakIcon getIcon(IconEnum i, String channel) {
        ...
        switch (i) {
            ...
            case SUBSCRIBER:
                ...
                break;
            case DONOR_BASIC:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/green.png"));
                break;
            case DONOR_LOW:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/bronze.png"));
                break;
            case DONOR_MEDIUM:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/silver.png"));
                break;
            case DONOR_HIGH:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/gold.png"));
                break;
            case DONOR_INSANE:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/diamond.png"));
                break;
            case GLOBALMOD:
                icon = sizeIcon(ChatPane.class.getResource("/com/gocnak/image/globalmod.png"));
                break;
            case NONE:
                break;
            default:
