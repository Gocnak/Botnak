...
public class FrankerFaceZ extends ToggleableFace {
    ...
    /**
     * Constructs a com.gocnak.face emote from the FrankerFaceZ site.
     *
     * @param regex    The regex of the com.gocnak.face.
     * @param filePath The file path to the com.gocnak.face.
     * @param enabled  If the com.gocnak.face is enabled or not.
     */
