...
import com.gocnak.irc.Subscriber;
import com.gocnak.irc.account.Account;
import com.gocnak.irc.account.AccountManager;
...
import com.gocnak.util.comm.Command;
import com.gocnak.util.comm.ConsoleCommand;
import com.gocnak.util.misc.Donation;
import org.jibble.pircbot.ChannelManager;
...
public class Settings {
    ...
    public static String lookAndFeel = "com.jtattoo.plaf.hifi.HiFiLookAndFeel";
    ...
    public Settings() {//default account
        modIcon = Settings.class.getResource("/com/gocnak/image/mod.png");
        broadIcon = Settings.class.getResource("/com/gocnak/image/broad.png");
        adminIcon = Settings.class.getResource("/com/gocnak/image/admin.png");
        staffIcon = Settings.class.getResource("/com/gocnak/image/staff.png");
        turboIcon = Settings.class.getResource("/com/gocnak/image/turbo.png");
