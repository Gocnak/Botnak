package com.gocnak.gui;

import com.gocnak.irc.account.Account;
import com.gocnak.irc.account.Oauth;
import com.gocnak.irc.account.Task;
import com.gocnak.lib.scalr.Scalr;
import com.gocnak.sound.Sound;
...
public class GUISettings extends JFrame {
    ...
    void save() {
        ...
        try {
            if (useCustomMod.isSelected()) {
                ...
                GUIMain.currentSettings.modIcon = GUISettings.class.getResource("/com/gocnak/image/mod.png");
            }
            if (useCustomBroad.isSelected()) {
                GUIMain.currentSettings.broadIcon = new URL(customBroad.getText());
            } else {
                GUIMain.currentSettings.broadIcon = GUISettings.class.getResource("/com/gocnak/image/broad.png");
            }
            if (useCustomAdmin.isSelected()) {
                GUIMain.currentSettings.adminIcon = new URL(customAdminField.getText());
            } else {
                GUIMain.currentSettings.adminIcon = GUISettings.class.getResource("/com/gocnak/image/admin.png");
            }
            if (useCustomStaff.isSelected()) {
                GUIMain.currentSettings.staffIcon = new URL(customStaffField.getText());
            } else {
                GUIMain.currentSettings.staffIcon = GUISettings.class.getResource("/com/gocnak/image/staff.png");
            }
        } catch (Exception e) {
        ...
        if (comm != null) {
            if (comm.equals("HiFi")) {
                Settings.lookAndFeel = "com.jtattoo.plaf.hifi.HiFiLookAndFeel";
            } else {
                Settings.lookAndFeel = "com.jtattoo.plaf.graphite.GraphiteLookAndFeel";
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/com/gocnak/image/icon.png")).getImage());
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== chatSettingsPanel ========
            {
                ...
                //---- label31 ----
                label31.setIcon(new ImageIcon(getClass().getResource("/com/gocnak/image/graphite.png")));

                //---- label30 ----
                label30.setIcon(new ImageIcon(getClass().getResource("/com/gocnak/image/hifi.png")));
