...
import com.gocnak.face.IconEnum;
import com.gocnak.face.Icons;
import com.gocnak.gui.listeners.ListenerFace;
...
import com.gocnak.irc.message.MessageWrapper;
...
public class ChatPane implements DocumentListener {
    ...
    public void createPopOut() {
        if (poppedOutPane == null) {
            ...
            frame.setIconImage(new ImageIcon(getClass().getResource("/com/gocnak/image/icon.png")).getImage());
